...
@Component({
  selector: 'app-pi-show-user',
  templateUrl: './pi-show-user.component.html',
  styleUrls: ['./pi-show-user.component.css'],
  providers: [DatePipe]
})
export class PiShowUserComponent implements OnInit {
  user : Employee;
  editorEnabled : false;
